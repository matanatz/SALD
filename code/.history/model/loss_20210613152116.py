...
class SALDLoss(GenLoss):
    ...
    def forward(self, network_outputs,normals_gt,normals_nonmnfld_gt,pnts_mnfld, gt_nonmnfld,epoch):
        ...
        if 'grad_on_surface' in network_outputs.keys():
        ...
        if 'non_mnfld_pred_grad' in network_outputs.keys():
            if self.grad_loss_weight > 0:# and epoch > 5000:
