...
def evaluate_with_load(gpu, conf, exps_folder_name, override, timestamp, checkpoint ,parallel, resolution, recon_only=False, plot_cmpr=True,eval_train=False,is_action=False):
...
def evaluate(network,exps_folder_name, experiment_name, timestamp, epoch, resolution, conf, index, recon_only,lat_vecs,plot_cmpr=False,with_gt=False,is_action=False):
