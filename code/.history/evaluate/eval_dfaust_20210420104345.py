...
def evaluate(network,exps_folder_name, experiment_name, timestamp, epoch, resolution, conf, index, chamfer_only, recon_only,lat_vecs,plot_cmpr=False,with_gt=False,is_action=False,with_opt=False):
