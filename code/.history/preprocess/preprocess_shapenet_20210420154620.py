...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/home/atzmonm/data/datasets/ShapeNetCore.v2', help="Path of unzipped d-faust scans.")
    parser.add_argument('--shapeindex', type=int,required=True,default=0, help="Shape index to be preprocessed.")
    ...
    for cat in sorted(os.listdir(os.path.join(datapath))):

            source = '/home/atzmonm/data/datasets/ShapeNetCore.v2/{0}/'.format(cat)
            output = os.path.join(data,'ShapeNet_processed/')
