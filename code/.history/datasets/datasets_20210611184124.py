...
if __name__ == '__main__':
    ...
    train_split_file = './confs/splits/{0}'.format('dfaust/train_all_every5.json')
    
    with open(train_split_file, "r") as f:
        train_split = json.load(f)

    ds = DFaustDataSet(split=train_split ,dataset_path='/home/atzmonm/data/datasets/dfaust/scans_processed_sal_sigma03',with_dist=True, dist_file_name='_dist_triangle',lengths=[],number_of_points=32,preload=False)
    ...
    for data in dataloader:
        pnts = data[0][0]
        print (pnts.mean(0))
        plot_threed_scatter(pnts.squeeze(),'.',0,0)
        break
